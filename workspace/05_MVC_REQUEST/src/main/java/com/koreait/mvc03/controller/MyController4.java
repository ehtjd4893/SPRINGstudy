...
public class MyController4 {
		 ...
		 * 2. Model은 응답view로 값을 전달할 때 사용된다.
		 * 3. Model은 내부적으로 request attribute를 이용한다.
		 *  - 기존: request.getAttribute("속성명", 값)
		 *  - Model: model.addAttribute("속성명", 값)
		 * 4. new Model()은 불가능하다. 메소드의 매개변수에 선언하고 사용한다.
		 * */
	
	@RequestMapping(value="f3/v01")
	...
	// <bean id="p1" class="com.kreait.mvc003.dto.Person">
